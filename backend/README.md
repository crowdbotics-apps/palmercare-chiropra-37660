...
## Project Structure
    ...
    ├── palmercare_chiropra_37660  # Django project configurations
...
1. Clone this repo and `cd palmercare_chiropra_37660`
...
2. Clone this repo and `cd palmercare_chiropra_37660`
